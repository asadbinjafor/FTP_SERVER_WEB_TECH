<?php include '../control/moderator_content_form_process.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title>Add Content — Moderator</title><link rel="stylesheet" href="../css/task1_style.css"></head>
<body>
<?php $navActive = "contents"; include 'nav_staff.php'; ?>
<div class="main-wrap">
    <h1 class="section-title">Add Media Content</h1>
    ...
    <form method="post" enctype="multipart/form-data" class="card" onsubmit="return validateContentUpload()">
        ...
        <div class="form-group"><label>File</label><input type="file" name="content_file" required></div>
